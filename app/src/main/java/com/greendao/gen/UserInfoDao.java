...
public class UserInfoDao extends AbstractDao<UserInfo, Void> {
    ...
    public static class Properties {
        ...
        public final static Property Hxid = new Property(1, String.class, "hxid", false, "HXID");
    ...
    public UserInfo readEntity(Cursor cursor, int offset) {
        UserInfo entity = new UserInfo( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // hxid
    ...
    public void readEntity(Cursor cursor, UserInfo entity, int offset) {
        ...
        entity.setHxid(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
